...
public class DetailsEmployeePage {
    ...
    public static final Target LIST_FILENAME_ATTACHMENTS = Target.the("Lista de documentos cargados").locatedBy("//div[contains(@class,'table-cell')][2]/child::div");
    public static final Target ICON_DELETE_FILE= Target.the("Icono de eliminación de archivo").locatedBy("(//div[contains(@class,'table-cell')][2]/child::div[text()]/following::i[contains(@class,'trash')])[1]");
